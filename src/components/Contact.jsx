          ...
          <div className="bg-slate-900/30 border border-slate-800 p-8 rounded-2xl">
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-500 transition-colors">
          ...
          <div className="flex flex-col justify-center space-y-12">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-xs text-slate-500 uppercase tracking-widest font-bold mb-1">Email directo</p>
                  <p className="text-lg text-white font-medium">contacto@iabugu.com</p>
                </div>
              </div>
